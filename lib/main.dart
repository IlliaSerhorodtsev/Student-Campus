...
import 'package:flutter_lab_2_1/Campus.dart';
import 'package:flutter_lab_2_1/InfoPage.dart';
...
class CardWidget extends StatelessWidget {
  ...
  void _onCardPressed(BuildContext context) {
    ...
    Navigator.push(
      context,
      PageTransition(
        type: PageTransitionType.fade, // Вид анимации при переходе
        duration: Duration(milliseconds: 1000), // Продолжительность анимации
        child: CampusPage(_info,
            imageUrl), // Вместо CampusPage() укажите виджет страницы, на которую хотите перейти
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: InkWell(
        onTap: () => _onCardPressed(context), // Обработчик нажатия на карточку
